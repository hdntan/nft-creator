...
box-sizing: border-box;
 ...
 background: radial-gradient(107.25% 65.08% at 32.08% -8.14%, rgba(62, 111, 255, 0.4) 0%, rgba(62, 111, 255, 0) 100%), rgba(17, 14, 3, 0.4);
...
const ButtonItem = styled.button<StyledComponentProps>`
  ...
  background-color: ${(props) => props.typeButton === 'manage' ? '#FED73B' : ' #000000'};
